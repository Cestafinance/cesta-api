...
module.exports = {
  ...
  cubanApeVaultContract,
  cubanApeStrategyContract,
  moneyPrinterVaultContract,
  moneyPrinterStrategyContract,
  uniBotContract,
  dvdDistBotContract,
  metaverseVaultContract,
  metaverseStrategyContract,
  metaverseVaultContractMainnet,
  metaverseStrategyContractMainnet,
  citadelV2VaultContract,
  citadelV2StrategyContract,
  daoStonksVaultContract,
  daoStonksStrategyContract,
  daoDegenVaultContract,
  daoDegenStrategyContract,
  daoSafuVaultContract,
  daoSafuStrategyContract,
  daoTAVaultContract,
  daoTAStrategyContract,
  avaxVaultContract,
  avaxStableVaultContract
};
